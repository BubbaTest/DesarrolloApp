...
(function(global, factory) {
  ...
  var defaultOptions = {
    ...
    labelIdle: [
      'Arraste su Documento aqui o <span class="filepond--label-action"> Buscar aqui </span>',
      Type.STRING
    ],
    labelInvalidField: ['Archivo no Valido', Type.STRING],
    labelFileWaitingForSize: ['Esperando por el Tamaño', Type.STRING],
    labelFileSizeNotAvailable: ['Tamaño de Archivo no disponible', Type.STRING],
    labelFileCountSingular: ['Archivo en la lista', Type.STRING],
    labelFileCountPlural: ['Archivos en la lista', Type.STRING],
    labelFileLoading: ['Subiendo', Type.STRING],
    labelFileAdded: ['Agregado', Type.STRING], // assistive only
    labelFileLoadError: ['Error en la Subida', Type.STRING],
    labelFileRemoved: ['Eliminado', Type.STRING], // assistive only
    labelFileRemoveError: ['Error durante la  eliminacion', Type.STRING],
    labelFileProcessing: ['Uploading', Type.STRING],
    labelFileProcessingComplete: ['Subida complete', Type.STRING],
    labelFileProcessingAborted: ['Subida cancelled', Type.STRING],
    labelFileProcessingError: ['Error durante la Subida', Type.STRING],
    labelFileProcessingRevertError: ['Error durante la revercion', Type.STRING],

    labelTapToCancel: ['Click para cancelar', Type.STRING],
    labelTapToRetry: ['Click para intentar', Type.STRING],
    labelTapToUndo: ['tap to undo', Type.STRING],

    labelButtonRemoveItem: ['Elimnar', Type.STRING],
    labelButtonAbortItemLoad: ['Cancelar', Type.STRING],
