    ...
    (function (global, factory) {
      ...
      const downloadFile = (item, allowDownloadByUrl) => {
        ...
        //}
          ...
          alertify.alert("", "Descargando, espere un momento, Por favor...").set({ "closable": false, 'basic': true }).show();
        

          var urlFinal = location.origin + location.pathname;

          urlFinal = urlFinal + item.file.url;
